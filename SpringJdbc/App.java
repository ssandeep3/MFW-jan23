...
class dataSource{
	...
	dataSource(){
		System.out.println("from constructor dataSource...");
	}
	@Bean
	public void setJdbcTemplate(JdbcTemplate jdbcTemplate) {
		System.out.println("From setJdbcTemplate...");
		this.jdbcTemplate = jdbcTemplate;
    }
	@Bean
	public void insertData() {
		System.out.println("This is from insertData function...");
	   	String query = "insert into login values('Amit','abcd1234')";
	   	jdbcTemplate.execute("use library");
